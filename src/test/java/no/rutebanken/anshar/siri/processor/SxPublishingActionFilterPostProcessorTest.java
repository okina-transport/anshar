...
class SxPublishingActionFilterPostProcessorTest {
    ...
    private SituationExchangeDeliveryStructure deliveryWithSituations(PtSituationElement... situations) {
    ...
    private PublishToWebAction buildAction(PublishToWebAction action, String actionDataName, String promptValue) {
        fillActionData(action, actionDataName, promptValue);
        return action;
    }

    private PublishToTvAction buildAction(PublishToTvAction action, String actionDataName, String promptValue) {
        fillActionData(action, actionDataName, promptValue);
        return action;
    }

    private PublishToAlertsAction buildAction(PublishToAlertsAction action, String actionDataName, String promptValue) {
        fillActionData(action, actionDataName, promptValue);
        return action;
    }

    private PublishToDisplayAction buildAction(PublishToDisplayAction action, String actionDataName, String promptValue) {
        fillActionData(action, actionDataName, promptValue);
        return action;
    }

    private PublishToMobileAction buildAction(PublishToMobileAction action, String actionDataName, String promptValue) {
        fillActionData(action, actionDataName, promptValue);
        return action;
    }

    private void fillActionData(ParameterisedActionStructure action, String actionDataName, String promptValue) {
        ActionDataStructure actionData = new ActionDataStructure();
