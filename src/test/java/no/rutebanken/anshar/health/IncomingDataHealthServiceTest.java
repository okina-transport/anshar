...
class IncomingDataHealthServiceTest extends SpringBootBaseTest {

    @Autowired
    private IncomingDataHealthService incomingDataHealthService;

    @Test
    void testIncomingDataHealthService() {
        ...
        flowParameters.setType(IncomingFlowType.SIRI);
        ...
        flowParameters2.setType(IncomingFlowType.SIRI);
