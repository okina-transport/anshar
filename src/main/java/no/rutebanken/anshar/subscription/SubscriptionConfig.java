...
public class SubscriptionConfig {
    ...
    public void mergeSubscriptions(List<SubscriptionSetup> incomingSubscriptions) {
        ...
        for (SubscriptionSetup incomingSubscription : incomingSubscriptions) {
            ...
            if (existingSubscriptionOpt.isPresent()) {
                ...
                existingSubscription.setOperatorRefValue(incomingSubscription.getOperatorRefValue());
                existingSubscription.setNetworkRefValue(incomingSubscription.getNetworkRefValue());
            } else {
    ...
    public Optional<String> findDatasetFromSearch(String searchedId, ObjectType objectType) {
        return findDatasetFromSearch(Set.of(searchedId), objectType);
    }
