...
/**
 * Verifies that the value for field ExpectedArrivalTime is a valid timestamp, and that it is before or equal to ExpectedDepartureTime
 */
@Validator(profileName = "france", targetType = SiriDataType.ESTIMATED_TIMETABLE)
@Component
public class EstimatedExpectedArrivalTimeValidator extends TimeValidator {


    private static final String FIELDNAME = "ExpectedArrivalTime";
    private String path = ESTIMATED_CALL + FIELD_DELIMITER + FIELDNAME;

    private String comparisonFieldName = "ExpectedDepartureTime";
