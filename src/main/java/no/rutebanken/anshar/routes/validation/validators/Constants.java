...
public class Constants {
    ...
    public static final String CLOSE_MISSING_ALERTS_HEADER_NAME = "CLOSE_MISSING_ALERTS";
    public static final String INCOMING_FLOW_PARAMETERS_HEADER_NAME = "incomingFlowParameters";
