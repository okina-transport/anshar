...
//                .endpointProperty("httpBindingRef", "#contentEncodingRequestFilter")
                ...
                .corsHeaderProperty("Access-Control-Allow-Headers", "Origin, Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, Authorization, X-Gravitee-Api-Key, useOriginalId, datasetId, useAltId, gmSIVSicAQuay, X-User-Name")
        ;
