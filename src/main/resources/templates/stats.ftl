...
<div class="jumbotron text-center">
    ...
    <#if body.vmServerStarted??>
        <table align="center">
            <tr>
                <td align="right"><small>Proxyserver started:&nbsp;</small></td>
                <td><small>${body.serverStarted}</small></td>
            </tr>
            <tr>
                <td align="right"><small>VM-server started:&nbsp;</small></td>
                <td><small>${body.vmServerStarted}</small></td>
            </tr>
            <tr>
                <td align="right"><small>ET-server started:&nbsp;</small></td>
                <td><small>${body.etServerStarted}</small></td>
            </tr>
            <tr>
                <td align="right"><small>SX-server started:&nbsp;</small></td>
                <td><small>${body.sxServerStarted}</small></td>
            </tr>
        </table>
    <#else>
...
<div class="container">
    ...
    <ul class="nav nav-tabs" id="tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="inbound-tab" data-toggle="tab" href="#inbound"
               onclick="location.hash='inbound'" role="tab" aria-controls="inbound" aria-selected="true">Inbound <span
                        class="badge alert-success"></span> <span class="glyphicon glyphicon-arrow-down"></span> </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="outbound-tab" data-toggle="tab" href="#outbound" onclick="location.hash='outbound'"
               role="tab" aria-controls="outbound" aria-selected="false">Outbound <span
                        class="badge alert-success">${body.outbound?size}</span> <span
                        class="glyphicon glyphicon-arrow-up"></span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="polling-tab" data-toggle="tab" href="#polling" onclick="location.hash='polling'"
               role="tab" aria-controls="polling" aria-selected="false">Polling clients <span
                        class="glyphicon glyphicon-arrow-down"></span><span class="glyphicon glyphicon-arrow-up"></span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="distribution-tab" data-toggle="tab" href="#distribution"
               onclick="location.hash='distribution'" role="tab" aria-controls="distribution" aria-selected="false">Distribution
                <span class="glyphicon glyphicon-equalizer"></span></a>
        </li>
        <li class="nav-item text-right">
            <a class="nav-link" id="admin-tab" data-toggle="tab" href="#admin" onclick="location.hash='admin'"
               role="tab" aria-controls="admin" aria-selected="false">Admin <span
        ...
        <div class="tab-pane" id="inbound" role="tabpanel" aria-labelledby="inbound-tab">
            ...
            <#list body.types as type>
                <table class="table">
                    <thead>
                    <tr>
                        <th colspan="9"><h4>${type.typeName}</h4></th>
                    </tr>
                    ...
                    <#list type.subscriptions?sort_by("vendor") as item>
                        <tr data-toggle="collapse" data-target="#accordion${type?counter}-${item?counter}"
                            style="cursor: pointer"
                            class="clickable ${item.healthy???then(item.healthy?then("success","danger"), "warning")}">
                        ...
                        <tr id="accordion${type?counter}-${item?counter}"
                            class="collapse ${item.healthy???then(item.healthy?then("success","danger"), "warning")}">
                            <td colspan="9">
                                <table class="table table-striped">
                                    <tr>
                                        <th>Dataset ID</th>
                                        <td><a href="${item.validationUrl}" target="_blank">${item.datasetId}</a></td>
                                    </tr>
                                    <tr>
                                        <th>Vendor ID</th>
                                        <td>${item.vendor}</td>
                                    ...
                                    <tr>
                                        <th>Preview interval</th>
                                        <td>${item.previewInterval}</td>
                                    </tr>
                                    <tr>
                                        <th>Change before updates</th>
                                        <td>${item.changeBeforeUpdates}</td>
                                    </tr>
                                    <tr>
                                        <th>Incremental updates</th>
                                        <td>${item.incrementalUpdates}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Duration</th>
                                        <td>${item.durationOfSubscription}</td>
                                    </tr>
                                    <tr>
                                        <th>Restart time</th>
                                    ...
                                    <tr>
                                        <th>Forward positiondata</th>
                                        <td>${item.forwardPositionData?c}</td>
                                    </tr>
                                    <tr>
                                        <th>Id</th>
                                        ...
                                        <td>
                                            <#if item.status=='deactivated'>
                                                <button type="button" class="btn btn-danger" disabled
                                                        onclick="administerSubscription('stop', '${item.subscriptionId}')">
                                                    Stop
                                                </button>
                                                <button type="button" class="btn btn-success"
                                                        onclick="administerSubscription('start', '${item.subscriptionId}')">
                                                    Start
                                                </button>
                                            <#else >
                                        ...
                                        <td>
                                            <div align="right">
                                                <span style="cursor: pointer" class="glyphicon glyphicon-trash"
                                                      onclick="administerSubscription('flush', '${item.subscriptionId}')"></span>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
            ...
            <table class="table table-striped">
                ...
                <#list body.outbound?sort_by("subscriptionRef") as item>
                    <tr>
                        ...
                        <td>${item.filteredRefs}</td>
                        <td>
                            <span style="cursor: pointer" class="glyphicon glyphicon-trash"
                                  onclick="administerSubscription('terminate', '${item.subscriptionRef}')"></span>
                        </td>
                    </tr>
                </#list>
                </tbody>
        ...
        <div class="tab-pane" id="polling" role="tabpanel" aria-labelledby="polling-tab">
            ...
            <#list body.polling as pollingClient>
                <table class="table">
                    <thead>
                    <tr>
                        <th colspan="8"><h4>${pollingClient.typeName}</h4></th>
                    </tr>
...
- ${timestamp}</#list>">${item.lastRequests[0]}</span>
        ...
        <div class="tab-pane" id="distribution" role="tabpanel" aria-labelledby="distribution-tab">
            <table class="table table-striped">
                <thead>
                <tr>
                    <th colspan="2"><h4>Active data per codespace:</h4></th>
                </tr>
                <tr>
                    <th>Codespace</th>
        ...
        <div class="tab-pane" id="admin" role="tabpanel" aria-labelledby="admin-tab">
            <table class="table table-striped">
                <thead>
                <tr>
                    <th colspan="2"><h4>Admin tools:</h4></th>
                </tr>
                </thead>
                <tbody>
                <tr data-toggle="collapse" data-target="#accordion_admin_validate" style="cursor: pointer"
                ...
                <tr id="accordion_admin_validate" class="collapse ">
                    ...
                    <td>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('validateAll', '')"><span style="cursor: pointer"
                ...
                <tr data-toggle="collapse" data-target="#accordion_admin_terminate" style="cursor: pointer"
                ...
                <tr id="accordion_admin_terminate" class="collapse ">
                    ...
                    <td>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('terminateAll', '')"><span style="cursor: pointer"
                        ...
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('terminateAll', null, 'ESTIMATED_TIMETABLE')"><span
                                        style="cursor: pointer" class="glyphicon glyphicon-stop"></span> ET
                            </button>
                        </p>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('terminateAll', null, 'VEHICLE_MONITORING')"><span
                                        style="cursor: pointer" class="glyphicon glyphicon-stop"></span> VM
                            </button>
                        </p>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('terminateAll', null, 'SITUATION_EXCHANGE')"><span
                                        style="cursor: pointer" class="glyphicon glyphicon-stop"></span> SX
                            </button>
                        </p>
                    </td>
                </tr>

                <tr data-toggle="collapse" data-target="#accordion_admin_start" style="cursor: pointer"
                    class="clickable success">
                ...
                <tr id="accordion_admin_start" class="collapse ">
                    <td>
                        ...
                        Use case: Server has just been started, and all subscriptions should be activated ASAP instead
                        of waiting for health-trigger.
                    </td>
                    <td>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('startAll', '')"><span style="cursor: pointer"
                        ...
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('startAll', null, 'ESTIMATED_TIMETABLE')"><span
                                        style="cursor: pointer" class="glyphicon glyphicon-refresh"></span> ET
                            </button>
                        </p>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('startAll', null, 'VEHICLE_MONITORING')"><span
                                        style="cursor: pointer" class="glyphicon glyphicon-refresh"></span> VM
                            </button>
                        </p>
                        <p>
                            <button type="button" class="btn btn-danger"
                                    onclick="administerSubscription('startAll', null, 'SITUATION_EXCHANGE')"><span
                                        style="cursor: pointer" class="glyphicon glyphicon-refresh"></span> SX
                            </button>
                        </p>
                    </td>
                </tr>

                <tr data-toggle="collapse" data-target="#accordion_admin_delete" style="cursor: pointer"
                    class="clickable success">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <strong>Note: this removes the <i>record</i>, a redeploy is necessary to remove all
                                        traces.</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <#list body.types as type>
                                        <table class="table">
                                            <tr>
                                                <th colspan="4"><h4>${type.typeName}</h4></th>
                                            </tr>
                                            <#list type.subscriptions?sort_by("vendor") as item>
                                                <tr>
                                                    <th style="vertical-align: middle">${item?counter}</th>
                                                    ...
                                                    <td>
                                                        <div align="right">
                                                            <span style="cursor: pointer"
                                                                  ...
                                                                  onclick="administerSubscription('delete', '${item.subscriptionId}')"></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </#list>
